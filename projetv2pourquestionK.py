...
def Dbis(fichier_voulu, format_fichier, penalite_decalage=-1, score_correspondance=1, penalite_non_correspondance=-1):                          #creation d'une fonction d'alignement en fonction d'un fichier choisi,on peut changer les valeurs pour le score
...
def E():                                                                                                    #creer un fichier qui liste les positions où les sequences sont différentes
    ...
    with open("resultatComparaison_geneS.txt", "a") as fd:                                                  #ouverture du fichier en ajout
        ma_seq = list(SeqIO.parse("alignement.fasta","fasta"))                                              #creation d'une liste d'element fasta      
